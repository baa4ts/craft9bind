...
function RouteComponent() {
    ...
    // Reactividad
    //
    const nameServers = useStore(formulario.store, (state) => state.values.nameServers);
    ...
    const removerNameServer = (index: number) => {
        formulario.setFieldValue("nameServers", nameServers.filter((_, i) => i !== index))
    }
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div className="flex flex-col gap-1.5">
                                <formulario.Field name='authoritativeServer'>
                                    {(field) => (
                                        <>
                                            <Label htmlFor="authoritativeServer">Servidor autoritativo (SOA)</Label>
                                            <Input
