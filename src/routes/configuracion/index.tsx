                ...
                <Card>
                    ...
                    <CardContent>
                        <p className="text-sm leading-relaxed text-muted-foreground">
                            ...
                            recursion, interfaces de escucha, permisos de consulta y
                            politicas RPZ. Los valores definidos aqui se utilizaran para
                            generar automaticamente el archivo de configuracion principal
                            de BIND9.
                        </p>
                    </CardContent>
                </Card>
                                ...
                                {(field) => (
                                    <>
                                        ...
                                        <p className="text-xs text-muted-foreground">
                                            Valor que se mostrara cuando un host consulte la version del servidor DNS.
                                        </p>
                                    </>
                                )}
                            </formulario.Field>
                            ...
                            <formulario.Field name='dnssecValidation'>
                                {(field) => (
                                    <>
                                        <Select
                                            value={field.state.value}
                                            onValueChange={(value) => field.handleChange(value as Configuracion["dnssecValidation"])}
                                        >
                                            <SelectTrigger>
                        ...
                        <>
                            <Card>
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        Permite que el servidor DNS consulte servidores externos para resolver nombres que no puedan responderse con las zonas configuradas localmente.
                                    </CardDescription>
                                </CardHeader>
                        ...
                        <>
                            <Card>
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        Define que direcciones IP o redes pueden realizar consultas DNS a este servidor.
                                    </CardDescription>
                                </CardHeader>
                                ...
                                <CardContent>
                                    ...
                                    <p className="mt-2 text-xs text-muted-foreground">
                                        Ejemplos de valores validos para la directiva <code>allow-query</code>.
                                    </p>
                    ...
                    {(field) => (<>
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Define que servidores pueden copiar las zonas DNS configuradas en este servidor.
                                    Se recomienda mantener esta opcion deshabilitada salvo que utilices servidores secundarios.
                                </CardDescription>
                            </CardHeader>
                            ...
                            <CardContent>
                                ...
                                <p className="mt-2 text-xs text-muted-foreground">
                                    Ejemplos de valores validos para la directiva <code>allow-transfer</code>.
                                </p>
                    ...
                    {(field) => (<>
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Define que hosts pueden modificar registros DNS mediante actualizaciones
                                    dinamicas (DDNS). En la mayoria de los entornos esta opcion debe permanecer deshabilitada.
                                </CardDescription>
                            </CardHeader>
                            ...
                            <CardContent>
                                ...
                                <p className="mt-2 text-xs text-muted-foreground">
                                    Ejemplos de valores validos para la directiva <code>allow-update</code>.
                                </p>
